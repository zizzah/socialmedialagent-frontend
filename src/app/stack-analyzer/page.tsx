            ...
            <div className={cn(
                ...
                <div className="h-auto lg:h-40 p-4 border-b border-gray-100/50">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h1 className="text-lg lg:text-xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                                Open Gemini Canvas
                            </h1>
                            <p className="text-xs lg:text-sm text-gray-600">Advanced AI Canvas</p>
                        </div>
                    </div>
                ...
                <div className="bg-white/80 backdrop-blur-xl border-b border-gray-200/50 p-4 lg:p-6 shadow-sm flex-shrink-0">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3 lg:gap-4 ml-12 lg:ml-0">
                            <div className="w-6 h-6 lg:w-8 lg:h-8 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-lg flex items-center justify-center">
                                <Sparkles className="w-4 h-4 lg:w-5 lg:h-5 text-white" />
                            </div>
                            <div>
                                <h2 className="text-lg lg:text-2xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent">
                                    Analyze Github Repositories
                                </h2>
                                <p className="text-xs lg:text-sm text-gray-600">Powered by Gemini AI & Google Web Search</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            {isAgentActive && <Badge className="bg-gradient-to-r from-green-500 to-emerald-500 text-white border-0 shadow-sm text-xs lg:text-sm hidden sm:flex">
