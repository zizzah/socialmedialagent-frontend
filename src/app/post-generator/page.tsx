...
export default function PostGenerator() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 overflow-hidden">
      {/* Mobile Header */}
      <div className="lg:hidden bg-white/80 backdrop-blur-xl border-b border-gray-200/50 p-4 flex items-center justify-between">
        ...
        <Button
          ...
          className="lg:hidden"
        >
          {isMobileSidebarOpen ? <XCircle className="h-5 w-5" /> : <Menu className="h-5 w-5" />}
        </Button>
      </div>

      {/* Sidebar - Mobile Overlay / Desktop Fixed */}
      <div className={cn(
        "fixed lg:relative inset-0 z-50 lg:z-0 transition-transform duration-300",
        "lg:flex lg:flex-col lg:w-80 lg:translate-x-0",
        ...
        {/* Sidebar Content */}
        <div className="relative flex flex-col h-full w-80 bg-white/95 lg:bg-white/80 backdrop-blur-xl border-r border-gray-200/50 shadow-xl">
          {/* Header - Hidden on mobile (shown in top bar instead) */}
          <div className="hidden lg:block h-40 p-4 border-b border-gray-100/50">
          ...
          <div className="lg:hidden p-4 border-b border-gray-100/50">
            <div className="space-y-3">
              <label className="text-sm font-semibold text-gray-700">Active Agent</label>
              <div className="relative dropdown-container">
                <button
                  onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                  className="w-full p-3 pr-8 border border-gray-200/50 rounded-xl bg-white/50 backdrop-blur-sm text-sm transition-all duration-300 shadow-sm hover:shadow-md hover:bg-white/70 flex items-center justify-between"
                >
                  <div className="flex items-center gap-2">
                    <div className={`w-5 h-5 bg-gradient-to-r ${selectedAgent.gradient} rounded-lg flex items-center justify-center`}>
                  ...
                  <div className="p-1">
                    {agents.map((agent) => (
                      <button
                        ...
                        className="w-full p-2.5 rounded-lg text-left transition-all duration-200 flex items-center gap-2 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50"
                      >
                        <div className={`w-5 h-5 bg-gradient-to-r ${agent.gradient} rounded-lg flex items-center justify-center`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Desktop Header */}
        <div className="hidden lg:block bg-white/80 backdrop-blur-xl border-b border-gray-200/50 p-6 shadow-sm flex-shrink-0">
        ...
        {/* Mobile Status Bar */}
        {isAgentActive && (
          <div className="lg:hidden bg-white/80 backdrop-blur-xl border-b border-gray-200/50 px-4 py-2">
          ...
          {showColumns ? (
            ...
            <div className="text-center py-8 lg:py-16 px-4">
              <div className="relative mb-6 lg:mb-8">
                <div className="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto shadow-2xl">
                  <Brain className="w-8 h-8 lg:w-10 lg:h-10 text-white" />
                </div>
              </div>
              <h3 className="text-xl lg:text-2xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent mb-2 lg:mb-3">
                Ready to Explore
              </h3>
              ...
              <div className="grid grid-cols-2 gap-3 lg:gap-4 max-w-lg mx-auto">
                {quickActions.map((action, index) => (
                  <Button
                    ...
                    variant="outline"
                    disabled={running}
                    className="h-auto p-4 lg:p-6 flex flex-col items-center gap-2 lg:gap-3 bg-white/50 backdrop-blur-sm border-gray-200/50 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 rounded-xl transition-all duration-300 group"
                    onClick={() => {
                      appendMessage(new TextMessage({
                        role: Role.User,
